...
namespace MultiWindow.EventSystems
{
	...
	public abstract class BaseInputModule : UnityEngine.EventSystems.UIBehaviour
	{
		...
		protected static UnityEngine.EventSystems.MoveDirection DetermineMoveDirection(float x, float y, float deadZone)
		{
			...
			{
				return x > 0 ? UnityEngine.EventSystems.MoveDirection.Right : UnityEngine.EventSystems.MoveDirection.Left;
			}

			return y > 0 ? UnityEngine.EventSystems.MoveDirection.Up : UnityEngine.EventSystems.MoveDirection.Down;
		}
