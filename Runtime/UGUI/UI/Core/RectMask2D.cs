...
{
	[AddComponentMenu("MultiWindowUI/Rect Mask 2D", 14)]
	[ExecuteAlways]
	...
	/// </remarks>
	public class RectMask2D : UnityEngine.EventSystems.UIBehaviour, UnityEngine.UI.IClipper, ICanvasRaycastFilter
	{
		[NonSerialized]
		private readonly RectangularVertexClipper m_VertexClipper = new();

		[NonSerialized]
		private RectTransform m_RectTransform;

		[NonSerialized]
		private HashSet<MaskableGraphic> m_MaskableTargets = new();

		[NonSerialized]
		private HashSet<UnityEngine.UI.IClippable> m_ClipTargets = new();

		[NonSerialized]
		private bool m_ShouldRecalculateClipRects;

		[NonSerialized]
		private List<RectMask2D> m_Clippers = new();
		...
		protected override void OnDisable()
		{
			...
			m_Clippers.Clear();
			UnityEngine.UI.ClipperRegistry.Disable(this);
			MaskUtilities.Notify2DMaskStateChanged(this);
		}
		...
		public virtual void PerformClipping()
		{
			...
			{
				foreach( UnityEngine.UI.IClippable clipTarget in m_ClipTargets)
				{
