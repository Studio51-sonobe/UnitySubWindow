	...
	public class MaskUtilities
	{
		public static void Notify2DMaskStateChanged(Component mask)
		{
			...
			for (var i = 0; i < components.Count; i++)
			{
				...
				var toNotify = components[i] as UnityEngine.UI.IClippable;
		...
		public static void NotifyStencilStateChanged(Component mask)
		{
			...
			for (var i = 0; i < components.Count; i++)
			{
				...
				var toNotify = components[i] as UnityEngine.UI.IMaskable;
		...
		public static RectMask2D GetRectMaskForClippable(UnityEngine.UI.IClippable clippable)
		{
