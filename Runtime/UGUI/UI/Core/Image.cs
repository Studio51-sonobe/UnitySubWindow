...
namespace MultiWindow.UI
{
	...
	/// </summary>
	public class Image : MaskableGraphic, ISerializationCallbackReceiver, UnityEngine.UI.ILayoutElement, ICanvasRaycastFilter
	{
		/// <summary>
		...
		static void AddQuad(UnityEngine.UI.VertexHelper vertexHelper, Vector3[] quadPositions, Color32 color, Vector3[] quadUVs)
		{
		...
		static void AddQuad(UnityEngine.UI.VertexHelper vertexHelper, Vector2 posMin, Vector2 posMax, Color32 color, Vector2 uvMin, Vector2 uvMax)
		{
			int startIndex = vertexHelper.currentVertCount;
