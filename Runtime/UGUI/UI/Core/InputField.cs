...
{
	[AddComponentMenu("MultiWindowUI/Legacy/Input Field", 103)]
		...
		, UnityEngine.UI.ILayoutElement
	{
		...
		{
			get{ return eventSystem?.currentInputModule?.input; }
		}
		...
		protected void UpdateLabel()
		{
			if (m_TextComponent != null && m_TextComponent.font != null && !m_PreventFontCallback)
			{
				...
				if (eventSystem != null && gameObject == eventSystem.currentSelectedGameObject && compositionString.Length > 0)
				{
