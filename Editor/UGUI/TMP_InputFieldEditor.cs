...
namespace MultiWindow.UI.Editor
{
	...
	public class TMP_InputFieldEditor : SelectableEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			m_foldout.fontSettings = EditorGUILayout.Foldout(m_foldout.fontSettings, "Input Field Settings", true, TMPro.EditorUtilities.TMP_UIStyleManager.boldFoldout);
						...
						if (EditorGUI.EndChangeCheck())
						{
							if (text != null)
							{
								if (m_LineType.enumValueIndex == (int)TMP_InputField.LineType.SingleLine)
									text.textWrappingMode = TMPro.TextWrappingModes.PreserveWhitespaceNoWrap;
								else
								{
			...
			m_foldout.extraSettings = EditorGUILayout.Foldout(m_foldout.extraSettings, "Control Settings", true, TMPro.EditorUtilities.TMP_UIStyleManager.boldFoldout);
